...
LABEL "org.opencontainers.image.source"="https://github.com/driphireweb/slack-notify-action"

WORKDIR ${GOPATH}/src/github.com/driphireweb/slack-notify-action
COPY main.go ${GOPATH}/src/github.com/driphireweb/slack-notify-action
